...
GOOD: // This constant defines the rotation angle in radians.

BAD: // Mat.PI / 2 (90 degrees) is used to rotate the image by 90 degrees clockwise (in radians).

## No specific dates or version numbers in comments.

GOOD: // This function processes the image data.

BAD: // This function processes the image data as of version 1.2.3.

## No specific names in comments, except they are necessary for understanding the code.

GOOD: // This function processes the image data.

BAD: // This function processes the image data for the Imaginer project.
