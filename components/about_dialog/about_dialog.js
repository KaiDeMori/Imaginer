...
export class About_dialog {
  ...
  populate_credits() {
    ...
    const credits_data = [
      { name: "claude-fable-5 [1M]", bold: true },
      { name: "claude-fable-5-1 [1M]", bold: false },
      { name: "claude-haiku-3-5", bold: false },
      { name: "claude-haiku-4-5", bold: false },
      { name: "claude-opus-3", bold: false },
      { name: "claude-opus-4-0", bold: false },
      { name: "claude-opus-4-1", bold: false },
      { name: "claude-opus-4-5", bold: false },
      { name: "claude-opus-4-6 [1M]", bold: false },
      { name: "claude-opus-4-7 [1M]", bold: false },
      { name: "claude-opus-4-8 [1M]", bold: false },
      { name: "claude-opus-5 [1M]", bold: false },
      { name: "claude-sonnet-3-5", bold: false },
      ...
      { name: "claude-sonnet-5 [1M]", bold: true },
      { name: "claude-3-5-haiku-20241022", bold: false },
      { name: "claude-3-5-sonnet-20241022", bold: false },
      { name: "claude-3-7-sonnet-20250219", bold: true },
      { name: "claude-3-opus-20240229", bold: false },
