...
// Main logic for region zoom animation using WebGL
import {
  mat_mul,
  mat_translate,
  mat_scale,
  ...
  build_trs_matrix,
} from "./image_region_zoom_utils.js";
...
const initial_rotation = Math.random() * Math.PI * 2;
const image_url = "../zoom_images_planete/100_alien_closeup.png";

// Animation state and WebGL variables
...
window.image_region_zoom_init = init;
