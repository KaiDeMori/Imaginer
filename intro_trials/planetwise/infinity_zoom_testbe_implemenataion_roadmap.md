...
- Embed the layer data directly in the code as a JavaScript array. Use the following format:
...
This array defines the zoom factor and image filename for each layer. Adjust or extend as needed for your project.
