...
- This document is optimized for both human and AI collaboration.
- Steps are clearly numbered and use explicit action verbs.
- Variables and parameters are defined at the top for easy reference and automation.
- Where human judgment is required, prompts for clarification are included.
...
<!-- AI: If unsure about the pivot, ask the user for clarification. -->
